...
class sudoku:
	...
	from ._utilities import _varBitmap,_procCell,_procCellList,getOrthogonalNeighbors,getRegion,_selectCellsMatchDigitSet,_selectCellsOnLine,_selectCellsInRowCol,_terminateCellsOnLine,_terminateCellsInRowCol,_evaluateHangingClues