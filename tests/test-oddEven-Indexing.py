...
class TestPuzzle(unittest.TestCase):
	...
	# Constraints tested: setEvenOddArray, setIndexing, setGivenArray
	...
	def test_puzzle(self):
		...
		self.assertEqual(p.findSolution(test=True),'968315247217489356345276198132968574789543621654721839471832965893654712526197483','Failed Blank Spaces')
