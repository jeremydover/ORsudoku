...
class TestPuzzle(unittest.TestCase):
	...
	def test_puzzle(self):
		...
		self.assertEqual(p.countSolutions(test=True),'1:624839715718546329953271468892163547435728196167954832286415973349687251571392684','Failed Circle in a Sprial')
