...
class TestPuzzle(unittest.TestCase):
	...
	def test_puzzle(self):
		...
		p.setGlobalWhispers()
		self.assertEqual(p.countSolutions(test=True),'1:597286314462531879831947625385712496724869531916453287158394762673125948249678153','Failed World Wide Whispers')
