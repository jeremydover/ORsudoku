...
class TestPuzzle(unittest.TestCase):
	...
	def test_puzzle(self):
		...
		self.assertEqual(p.countSolutions(test=True),'1:*7*945682313287146*9*5651*3*29874576183*4*291496*5*278383*2*49715698524*6*3174*1*387596226793154*8*','Failed Zeta and Kappa')
